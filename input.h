...
inline extern string inputString(string prompt, bool spaces)
{
	string input = "";
...
inline extern char inputChar(string prompt, string options)
{
	char input;
	do
	{
...
inline extern char inputChar(string prompt, char yes, char no)
{
	char input;
	do
	{
...
inline extern char inputChar(string prompt, bool alphaOrDigit)
{
	char input;
	do
	{
...
inline extern char inputChar(string prompt)
{
	char input;
	do
	{
...
inline extern int inputInteger(string prompt)
{
	int input;
	do
	{
...
inline extern int inputInteger(string prompt, bool posNeg)
{
	int input;
	do
	{
...
inline extern int inputInteger(string prompt, int start, bool greater)
{
	int input;
	do
	{
...
inline extern int inputInteger(string prompt, int startRange, int endRange)
{
	int input;
	do
	{
...
inline extern double inputDouble(string prompt)
{
	double input;
	do
	{
...
inline extern double inputDouble(string prompt, bool posNeg)
{
	double input;
	do
	{
...
//PreCondition: start(integer) and greater(boolean true or false)
//PostCondition: returns an integer value greater than start or lesser than start
inline extern double inputDouble(string prompt, double start, bool posNeg)
{
	double input;
	do
	{
...
//PreCondition: startRange (integer) and endRange (integer)
//PostCondition: returns an integer value within range (startRannge and endRange)
inline extern double inputDouble(string prompt, double startRange, double endRange)
{
	double input;
	do
	{
